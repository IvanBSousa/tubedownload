...
public class Search {
    ...
    public ArrayList<com.tubedownload.javatube.Playlist> getPlaylistsResults() throws Exception {
        ArrayList<com.tubedownload.javatube.Playlist> result = new ArrayList<>();
        if(results.isEmpty()){
            results = fetchAndParse();
        }
