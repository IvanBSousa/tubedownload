...
public class StreamQuery{
    private final List<com.tubedownload.javatube.Stream> fmtStreams;
    Map<Integer, com.tubedownload.javatube.Stream> itagIndex = new HashMap<>();
    
    public StreamQuery(List<com.tubedownload.javatube.Stream> fmt_streams){
        fmtStreams = fmt_streams;
        for (com.tubedownload.javatube.Stream fmt_stream : fmt_streams) {
    ...
    public List<com.tubedownload.javatube.Stream> getAll(){
        return fmtStreams;
    }

    public com.tubedownload.javatube.Stream get(int index){
    ...
    public static class Filter {
        ...
        public final List<Predicate<com.tubedownload.javatube.Stream>> customFilters;
        ...
        public static class Builder {
            ...
            private final List<Predicate<com.tubedownload.javatube.Stream>> customFilters = new ArrayList<>();
            ...
            // Filter additions
            public Builder addCustomFilter(Predicate<com.tubedownload.javatube.Stream> predicate) {
                if (predicate != null) this.customFilters.add(predicate);
                return this;
            }

            public Builder addCustomFilter(List<Predicate<com.tubedownload.javatube.Stream>> predicates) {
    ...
    public StreamQuery filter(Filter f) {
        List<Predicate<com.tubedownload.javatube.Stream>> filters = new ArrayList<>();
        ...
        if (Boolean.TRUE.equals(f.progressive) || Boolean.FALSE.equals(f.adaptive)) filters.add(com.tubedownload.javatube.Stream::isProgressive);
        if (Boolean.TRUE.equals(f.adaptive) || Boolean.FALSE.equals(f.progressive)) filters.add(com.tubedownload.javatube.Stream::isAdaptive);

        if (Boolean.TRUE.equals(f.sabr)) filters.add(com.tubedownload.javatube.Stream::getIsSabr);
    ...
    private StreamQuery _filter(List<Predicate<com.tubedownload.javatube.Stream>> filters) {
        List<com.tubedownload.javatube.Stream> result = fmtStreams;
        for (Predicate<com.tubedownload.javatube.Stream> f : filters) {
            result = result.stream().filter(f).collect(Collectors.toList());
        }
        return new StreamQuery(result);
    }

    public com.tubedownload.javatube.Stream getByItag(int itag) {
        return itagIndex.get(itag);
    }

    private ArrayList<com.tubedownload.javatube.Stream> progressive(){
        ArrayList<com.tubedownload.javatube.Stream> filter = new ArrayList<>();
        for(com.tubedownload.javatube.Stream st : fmtStreams){
            if(st.isProgressive()){
                filter.add(st);
            }
        }
    ...
    private ArrayList<com.tubedownload.javatube.Stream> adaptive(){
        ArrayList<com.tubedownload.javatube.Stream> filter = new ArrayList<>();
        for(com.tubedownload.javatube.Stream st : fmtStreams){
            if(st.isAdaptive()){
                filter.add(st);
    ...
    private List<com.tubedownload.javatube.Stream> reverseArrayList(List<com.tubedownload.javatube.Stream> aList) {
        ArrayList<com.tubedownload.javatube.Stream> revArrayList = new ArrayList<>();
    ...
    private static ArrayList<com.tubedownload.javatube.Stream> sortByValue(HashMap<com.tubedownload.javatube.Stream, Integer> hm) {
        List<Map.Entry<com.tubedownload.javatube.Stream, Integer>> list = new LinkedList<>(hm.entrySet());
        list.sort(Map.Entry.comparingByValue());
        ArrayList<com.tubedownload.javatube.Stream> ordered = new ArrayList<>();
        for (Map.Entry<com.tubedownload.javatube.Stream, Integer> aa : list) {
    ...
    public StreamQuery orderBy(String by) throws Exception {
        HashMap<com.tubedownload.javatube.Stream, Integer> map = new HashMap<>();
        for(com.tubedownload.javatube.Stream s : fmtStreams){
    ...
    public com.tubedownload.javatube.Stream getFirst(){
        return fmtStreams.get(0);
    }

    public com.tubedownload.javatube.Stream getLast(){
    ...
    public com.tubedownload.javatube.Stream getOnlyAudio(){
    ...
    public com.tubedownload.javatube.Stream getDefaultResolution(){
        return filter(Filter.builder()
                .progressive(true)
                .subtype("mp4")
                .build()
    ...
    public com.tubedownload.javatube.Stream getLowestResolution(){
        return filter(Filter.builder()
                .progressive(false)
                .type("video")
                .subtype("mp4")
    ...
    public com.tubedownload.javatube.Stream getHighestResolution(){
        return filter(Filter.builder()
                .progressive(false)
                .type("video")
                .subtype("mp4")
    ...
    public StreamQuery filter(HashMap<String, String> filters){
        ...
        ArrayList<com.tubedownload.javatube.Stream> streamFilter = new ArrayList<>();
    ...
    private ArrayList<com.tubedownload.javatube.Stream> getResolution(String re){
        ArrayList<com.tubedownload.javatube.Stream> filter = new ArrayList<>();
        for(com.tubedownload.javatube.Stream st : fmtStreams){
    ...
    private ArrayList<com.tubedownload.javatube.Stream> getFps(String fps){
        ArrayList<com.tubedownload.javatube.Stream> filter = new ArrayList<>();
        for(com.tubedownload.javatube.Stream st : fmtStreams){
    ...
    private ArrayList<com.tubedownload.javatube.Stream> getMineType(String mineType){
        ArrayList<com.tubedownload.javatube.Stream> filter = new ArrayList<>();
        for(com.tubedownload.javatube.Stream st : fmtStreams){
    ...
    private ArrayList<com.tubedownload.javatube.Stream> getType(String type){
        ArrayList<com.tubedownload.javatube.Stream> filter = new ArrayList<>();
        for(com.tubedownload.javatube.Stream st : fmtStreams){
    ...
    private ArrayList<com.tubedownload.javatube.Stream> getSubtype(String subtype){
        ArrayList<com.tubedownload.javatube.Stream> filter = new ArrayList<>();
        for(com.tubedownload.javatube.Stream st : fmtStreams){
    ...
    private ArrayList<com.tubedownload.javatube.Stream> getAbr(String abr){
        ArrayList<com.tubedownload.javatube.Stream> filter = new ArrayList<>();
        for(com.tubedownload.javatube.Stream st : fmtStreams){
    ...
    private ArrayList<com.tubedownload.javatube.Stream> getVideoCodec(String videoCodec){
        ArrayList<com.tubedownload.javatube.Stream> filter = new ArrayList<>();
        for(com.tubedownload.javatube.Stream st : fmtStreams){
    ...
    private ArrayList<com.tubedownload.javatube.Stream> getAudioCodec(String audioCodec){
        ArrayList<com.tubedownload.javatube.Stream> filter = new ArrayList<>();
        for(com.tubedownload.javatube.Stream st : fmtStreams){
    ...
    private ArrayList<com.tubedownload.javatube.Stream> onlyAudio(){
        ArrayList<com.tubedownload.javatube.Stream> filter = new ArrayList<>();
        for(com.tubedownload.javatube.Stream st : fmtStreams){
    ...
    private ArrayList<com.tubedownload.javatube.Stream> onlyVideo(){
        ArrayList<com.tubedownload.javatube.Stream> filter = new ArrayList<>();
