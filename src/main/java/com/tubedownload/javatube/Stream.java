...
import com.tubedownload.javatube.sabr.core.ServerAbrStream;
...
public class Stream{
    ...
    private void startDownload(String path, String fileName, BiConsumer<Long, Long> progress) throws Exception {
        ...
        if(isSabr){
            ...
            do {
                ...
                chunkReceived = com.tubedownload.javatube.Request.get(chunk).toByteArray();
    ...
    private void downloadOtf(String savePath) throws Exception {
        ...
        do {
            ...
            chunkReceived = com.tubedownload.javatube.Request.postChunk(chunk).toByteArray();
