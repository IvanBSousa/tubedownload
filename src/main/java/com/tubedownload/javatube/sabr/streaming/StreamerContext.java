package com.tubedownload.javatube.sabr.streaming;
...
import com.tubedownload.javatube.sabr.streaming.BufferedRange;
import com.tubedownload.javatube.sabr.streaming.PlaybackCookie;
...
public class StreamerContext {
    ...
    public byte[] poToken;
    public com.tubedownload.javatube.sabr.streaming.PlaybackCookie playbackCookie;
    public byte[] gp;
    ...
    public static BinaryWriter encode(StreamerContext message, BinaryWriter writer) {
        ...
        if (message.playbackCookie != null){
            writer.uint32(26).bytes(com.tubedownload.javatube.sabr.streaming.PlaybackCookie.encode(message.playbackCookie).finish());
        }
        if (message.gp != null){
